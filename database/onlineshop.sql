...
--
-- Table structure for table `page one`
--

CREATE TABLE `page_one` (
  `booking_id` int(30) NOT NULL,
  `arrival_date` int(30) NOT NULL,
...
--
-- Dumping data for table `page_one`
--

INSERT INTO `page_one` (`booking_id`, `arrival_date`, `full_name`, `email`, `contact`, `address`, `country`) VALUES
(1, 1, 8, 'Samsung galaxy s7 edge', 5000, 'Samsung galaxy s7 edge', 'product'),
(2, 1, 3, 'mugi', 25000, 'iphone 5s', 'http___plus'),
(3, 1, 3, 'kihara', 30000, 'ipad apple brand', 'da4371ffa1');
...
--
ALTER TABLE `page_one`
  MODIFY `booking_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
